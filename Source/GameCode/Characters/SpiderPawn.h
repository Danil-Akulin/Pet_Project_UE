...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Spider bot|IK settings", meta = (ClamnMin = 0.0f, UIMin = 0.0f))
	float IKTraceExtendDistance = 30.0f;

	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, Category = "Spider bot|IK settings", meta = (ClamnMin = 0.0f, UIMin = 0.0f))
